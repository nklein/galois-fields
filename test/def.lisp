...
(nst:def-test-group deffield-tests-for-gf3 ()
  (nst:def-test gf3-addition-function (:values (:equal 0) (:equal 1) (:equal 2)
    ...
    (values (gf+ gf3 0 0) (gf+ gf3 0 1) (gf3+ 0 2)
            (gf+ gf3 1 0) (gf+ gf3 1 1) (gf3+ 1 2)
            (gf+ gf3 2 0) (gf+ gf3 2 1) (gf3+ 2 2)))
...
(nst:def-test-group deffield-tests-for-gf4 ()
  (nst:def-test gf4-addition-function (:values (:equal 0) (:equal 1) (:equal 2) (:equal 3)
    ...
    (values (gf+ gf4 0 0) (gf+ gf4 0 1) (gf4+ 0 2) (gf4+ 0 3)
            (gf+ gf4 1 0) (gf+ gf4 1 1) (gf4+ 1 2) (gf4+ 1 3)
            (gf+ gf4 2 0) (gf+ gf4 2 1) (gf4+ 2 2) (gf4+ 2 3)
            (gf+ gf4 3 0) (gf+ gf4 3 1) (gf4+ 3 2) (gf4+ 3 3)))
...
(nst:def-test-group define-inline ()
  (nst:def-test gf4-addition-with-tables (:values (:equal 0) (:equal 1) (:equal 2) (:equal 3)
                                                  (:equal 1) (:equal 0) (:equal 3) (:equal 2)
                                                  (:equal 2) (:equal 3) (:equal 0) (:equal 1)
                                                  (:equal 3) (:equal 2) (:equal 1) (:equal 0))
    (let* ((gf4 (deffield* :p 2 :d 2 :use-tables t))
           (fn (gf+-function gf4)))
      (flet ((gf4+ (a b) (funcall fn a b)))
        (values (gf+ gf4 0 0) (gf+ gf4 0 1) (gf4+ 0 2) (gf4+ 0 3)
                (gf+ gf4 1 0) (gf+ gf4 1 1) (gf4+ 1 2) (gf4+ 1 3)
                (gf+ gf4 2 0) (gf+ gf4 2 1) (gf4+ 2 2) (gf4+ 2 3)
                (gf+ gf4 3 0) (gf+ gf4 3 1) (gf4+ 3 2) (gf4+ 3 3)))))

  (nst:def-test gf4-addition-without-tables (:values (:equal 0) (:equal 1) (:equal 2) (:equal 3)
                                                     (:equal 1) (:equal 0) (:equal 3) (:equal 2)
                                                     (:equal 2) (:equal 3) (:equal 0) (:equal 1)
                                                     (:equal 3) (:equal 2) (:equal 1) (:equal 0))
    (let* ((gf4 (deffield* :p 2 :d 2 :use-tables nil))
           (fn (gf+-function gf4)))
      (flet ((gf4+ (a b) (funcall fn a b)))
        (values (gf+ gf4 0 0) (gf+ gf4 0 1) (gf4+ 0 2) (gf4+ 0 3)
                (gf+ gf4 1 0) (gf+ gf4 1 1) (gf4+ 1 2) (gf4+ 1 3)
  ...
  (nst:def-test gf4-multiplication-with-tables (:values (:equal 0) (:equal 0) (:equal 0) (:equal 0)
                                                        (:equal 0) (:equal 1) (:equal 2) (:equal 3)
                                                        (:equal 0) (:equal 2) (:equal 3) (:equal 1)
                                                        (:equal 0) (:equal 3) (:equal 1) (:equal 2))
    (let* ((gf4 (deffield* :p 2 :d 2 :use-tables t))
  ...
  (nst:def-test gf4-multiplication-without-tables (:values (:equal 0) (:equal 0) (:equal 0) (:equal 0)
                                                           (:equal 0) (:equal 1) (:equal 2) (:equal 3)
                                                           (:equal 0) (:equal 2) (:equal 3) (:equal 1)
                                                           (:equal 0) (:equal 3) (:equal 1) (:equal 2))
    (let ((gf4 (deffield* :p 2 :d 2 :use-tables nil))
